...
var releases = {
	...
	iscroll: {
		...
		postProcessing: [ 'indicator/js.json', 'wheel/js.json', 'snap/js.json', 'keys/js.json' ]
	},
	...
	probe: {
		...
		postProcessing: [ 'indicator/js.json', 'wheel/js.json', 'snap/js.json', 'keys/js.json', 'probe/js.json' ]
	},
	...
	zoom: {
		...
		postProcessing: [ 'zoom/js.json', 'indicator/js.json', 'wheel/js.json', 'snap/js.json', 'keys/js.json' ]
	},
	...
	infinite: {
		...
		postProcessing: [ 'wheel/js.json', 'snap/js.json', 'keys/js.json', 'infinite/js.json', 'probe/js.json' ]
	}
};
...
function build (release) {
	...
	// Write js file
	var buildFile = './js/iscroll' + (release != 'iscroll' ? '-' + release : '') + '.js';
	...
	// Write dist file
	var distFile = buildFile.replace('/js/', '/dist/').replace('.js', '-min.js');
